            ...
            <form onSubmit={handleReplySubmit} className="pt-4 border-t border-gray-100 space-y-4">
              ...
              <div className="flex justify-end items-center gap-3">
                <button
                  ...
                  className="inline-flex items-center gap-1.5 bg-purple-50 hover:bg-purple-100 text-purple-700 border border-purple-200 text-sm font-semibold px-3.5 py-2 rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed shadow-sm"
                >
                  {isPolishing ? (
                    <>
