      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="flex items-center gap-2 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-200 px-4 py-2 rounded-xl text-sm font-medium hover:bg-slate-50 dark:hover:bg-slate-700 transition shadow-sm disabled:opacity-50"
          >
      ...
      {isLoading ? (
        ...
        <div className="max-w-7xl mx-auto space-y-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-5">
            ...
            <div className="bg-white dark:bg-slate-800 border border-slate-100 dark:border-slate-700 rounded-2xl p-5 shadow-sm hover:shadow-md transition relative overflow-hidden group">
              ...
              <div className="flex items-center justify-between mb-3">
                ...
                <span className="p-2.5 rounded-xl bg-blue-50 dark:bg-blue-900/40 text-blue-600">
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">Total received tickets</p>
            </div>
            ...
            <div className="bg-white dark:bg-slate-800 border border-slate-100 dark:border-slate-700 rounded-2xl p-5 shadow-sm hover:shadow-md transition relative overflow-hidden group">
              ...
              <div className="flex items-center justify-between mb-3">
                <span className="text-xs font-semibold uppercase tracking-wider text-amber-500">Open Tickets</span>
                <span className="p-2.5 rounded-xl bg-amber-50 dark:bg-amber-900/40 text-amber-600">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">Awaiting human agent action</p>
            </div>
            ...
            <div className="bg-white dark:bg-slate-800 border border-slate-100 dark:border-slate-700 rounded-2xl p-5 shadow-sm hover:shadow-md transition relative overflow-hidden group">
              ...
              <div className="flex items-center justify-between mb-3">
                <span className="text-xs font-semibold uppercase tracking-wider text-emerald-500">Resolved by AI</span>
                <span className="p-2.5 rounded-xl bg-emerald-50 dark:bg-emerald-900/40 text-emerald-600">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">Auto-resolved via KB</p>
            </div>
            ...
            <div className="bg-white dark:bg-slate-800 border border-slate-100 dark:border-slate-700 rounded-2xl p-5 shadow-sm hover:shadow-md transition relative overflow-hidden group">
              ...
              <div className="flex items-center justify-between mb-3">
                <span className="text-xs font-semibold uppercase tracking-wider text-indigo-400">AI Resolution %</span>
                <span className="p-2.5 rounded-xl bg-indigo-50 dark:bg-indigo-900/40 text-indigo-600">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
                  </svg>
                </span>
              </div>
              <div className="text-3xl font-extrabold text-indigo-500">{aiPercentage}%</div>
            ...
            <div className="bg-white dark:bg-slate-800 border border-slate-100 dark:border-slate-700 rounded-2xl p-5 shadow-sm hover:shadow-md transition relative overflow-hidden group">
              ...
              <div className="flex items-center justify-between mb-3">
                ...
                <span className="p-2.5 rounded-xl bg-purple-50 dark:bg-purple-900/40 text-purple-600">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                </span>
              </div>
              <div className="text-3xl font-extrabold text-slate-900 dark:text-white">{avgTime}</div>
              <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">Average time to resolve</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 bg-[#E8EEFF] dark:bg-slate-800 border border-[#C9D7FF] dark:border-slate-700 rounded-3xl p-7 shadow-sm relative overflow-hidden">
              <div className="absolute -right-10 -bottom-10 w-64 h-64 bg-blue-400/10 rounded-full blur-3xl"></div>
              <div className="relative z-10">
                <div className="inline-flex items-center gap-2 bg-blue-100 dark:bg-blue-900/40 border border-blue-200 dark:border-blue-800 text-blue-700 dark:text-blue-300 text-xs px-3 py-1 rounded-full font-medium mb-4">
                  <span>✨</span> AI Automation Active
                </div>
                <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-2">Automated AI Agent Workflow</h2>
                <p className="text-slate-600 dark:text-slate-300 text-sm max-w-xl mb-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 border-t border-[#C9D7FF] dark:border-slate-700 pt-6">
                  <div>
            ...
            <div className="bg-white dark:bg-slate-800 border border-slate-100 dark:border-slate-700 rounded-3xl p-6 shadow-sm flex flex-col justify-between">
              <div>
                ...
                <div className="space-y-3">
                  <Link
                    to="/tickets"
                    className="flex items-center justify-between p-3.5 rounded-2xl bg-slate-50 dark:bg-slate-700/50 hover:bg-blue-50/50 dark:hover:bg-blue-900/20 border border-slate-200/60 dark:border-slate-600/60 transition group"
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="text-sm font-semibold text-slate-900 dark:text-slate-100 group-hover:text-blue-600 transition">
                          Human Agent Queue
                        </div>
                        <div className="text-xs text-slate-500 dark:text-slate-400">{open} open tickets awaiting response</div>
                      </div>
                    </div>
                    <span className="text-slate-400 group-hover:translate-x-1 transition font-bold">→</span>
                  </Link>

                  <div className="p-3.5 rounded-2xl bg-slate-50 dark:bg-slate-700/50 border border-slate-200/60 dark:border-slate-600/60 flex items-center gap-3">
                    <span className="p-2 rounded-xl bg-emerald-100 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-300">
                      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                      </svg>
                    </span>
                    <div>
                      <div className="text-sm font-semibold text-slate-900 dark:text-slate-100">Knowledge Base Active</div>
                      <div className="text-xs text-slate-500 dark:text-slate-400">4 article topics loaded for auto-resolution</div>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="bg-white dark:bg-slate-800 border border-slate-100 dark:border-slate-700 rounded-3xl p-6 md:p-8 shadow-sm">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
              <div>
                <div className="flex items-center gap-2">
                  <span className="p-2 rounded-xl bg-blue-50 dark:bg-blue-900/40 text-blue-600">
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                    </svg>
                  </span>
                  <h2 className="text-xl font-bold text-slate-900 dark:text-white">Tickets per Day (Past 30 Days)</h2>
                </div>
                <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">Total tickets created per day over the last 30-day period</p>
              </div>

              <div className="flex items-center gap-3 text-xs">
                <div className="flex items-center gap-2 bg-slate-50 dark:bg-slate-700 px-3 py-1.5 rounded-xl border border-slate-100 dark:border-slate-600">
                  <span className="text-slate-400 dark:text-slate-400 font-medium">30-Day Total:</span>
                  <span className="font-bold text-slate-900 dark:text-white">{dailyTickets.reduce((sum, d) => sum + d.count, 0)} tickets</span>
                </div>
                <div className="flex items-center gap-2 bg-blue-50 dark:bg-blue-900/30 px-3 py-1.5 rounded-xl border border-blue-100 dark:border-blue-800 text-blue-700 dark:text-blue-300">
            ...
            <div className="relative pt-6 pb-2">
              <div className="h-48 flex items-end justify-between gap-1.5 md:gap-2">
                {dailyTickets.map((d, idx) => {
                  ...
                  return (
                    ...
                    >
                      {/* Hover Tooltip */}
                      <div className="absolute -top-10 opacity-0 group-hover:opacity-100 transition-all duration-200 pointer-events-none z-20 bg-slate-900 dark:bg-slate-700 text-white text-xs py-1 px-2.5 rounded-lg shadow-xl whitespace-nowrap">
                      ...
                      {d.count > 0 && (
                        <span className="text-[10px] font-bold text-slate-500 dark:text-slate-400 mb-1 opacity-80 group-hover:opacity-100 group-hover:text-blue-600 transition">
                          {d.count}
                        </span>
                      )}
              ...
              {/* X-Axis Date Labels */}
              <div className="flex items-center justify-between mt-3 pt-3 border-t border-slate-100 dark:border-slate-700 text-[11px] text-slate-400 font-medium">
